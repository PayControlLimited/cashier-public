...
import { useCallback as h, useContext as We, useEffect as g, useMemo as _, useRef as Ge, useState as v } from "react";
import { jsx as y, jsxs as Ke } from "react/jsx-runtime";
...
function Qe({ loaderPaymentTypes: Qe = [] }) {
	...
	return De("bottom", hn, hn.length > 0, { reserveSpace: j }), fe({
		...
		fitted: !0,
		stickyHeader: !0,
		children: /* @__PURE__ */ Ke("div", {
			className: me(b.className("route-payment-types-content"), "px-1.5 @sm:px-3", j ? "pb-3 @md:pb-4" : "pb-4", Je),
			children: [
				/* @__PURE__ */ Ke("div", {
...
var b = () => /* @__PURE__ */ y(je, { text: "payment.no_pts_found" });
//#endregion
