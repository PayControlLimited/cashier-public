...
import { t as Ue } from "./_method-ChhdsaPg.js";
import { useCallback as h, useContext as We, useEffect as Ge, useMemo as g, useRef as Ke, useState as _ } from "react";
import { Fragment as qe, jsx as v, jsxs as y } from "react/jsx-runtime";
...
function b() {
	let { paymentTypes: e } = Ue.useLoaderData();
	return /* @__PURE__ */ v(x, { loaderPaymentTypes: e });
}
function x({ loaderPaymentTypes: Ue = [] }) {
	let b = Re(), { translateKey: x } = le(), S = c(), { uiComboView: C, lockAmount: $e, uiComboView__PaymentTypes: et, uiInteractivePrompts: tt, uiPaymentConfirmView: nt, uiBonusesStyle: w, uiShowFees: T, uiListStyle: rt, selectedPaymentType: E, initialAmount: D, method: O, currency: k, user: A, locale: it, uiAccountDelete: at, uiListSelectable: ot, uiFixedControls: j, uiPreselectedPaymentType: st, onPaymentTypeSelected: M, onPaymentTypeDeselected: ct, paymentFormDraft: lt, comboViewFormDraft: ut, resetFlowOnBack: dt, setCashierState: N } = We(be), { currencyFormatter: ft, formatCurrencyValue: pt, formatDisplayValue: mt } = Ie(), { paymentTypesList: ht, isError: gt } = oe(), { getBonusCountForPaymentType: P, getBonusAvailabilityForPaymentType: _t, getAvailableBonusesForPaymentType: F } = s(), vt = g(() => Oe(ft), [ft]), { selectPaymentType: I, clearPaymentSelection: L } = ie(), { requestAccountDelete: yt, actionConfirmationModal: bt } = Ee(), xt = Ke(!1), [St, Ct] = _(null), [R, wt] = _({
		isComplete: !1,
		errorMessage: null,
		paymentTypeName: null
	}), [Tt, Et] = _(!1), [Dt, Ot] = _(!1), z = ht.length > 0 ? ht : Ue, kt = de({
		uiComboView: C,
		lockAmount: $e,
		method: O
	...
	return Ae("bottom", fn, fn.length > 0, { reserveSpace: j }), ce({
		...
		children: /* @__PURE__ */ y("div", {
			className: fe(b.className("route-payment-types-content"), "px-1.5 @sm:px-3", j ? "pb-3 @md:pb-4" : "pb-4", Ye),
			children: [
				Ht && /* @__PURE__ */ v(xe, {
				...
				W ? /* @__PURE__ */ y(qe, { children: [/* @__PURE__ */ v(Be, {
					paymentTypes: z,
				...
				})] }) : /* @__PURE__ */ y(qe, { children: [/* @__PURE__ */ v(ae, {
					paymentTypes: z,
					domScope: "route-payment-types",
					animateItems: !0,
					selectable: G,
