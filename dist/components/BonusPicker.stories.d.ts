...
declare function StoryHarness({ amount, selectedBonusCode, configuredBonuses, }: BonusPickerStoryProps): import("react/jsx-runtime").JSX.Element;
declare const meta: {
    title: string;
    ...
    render: (args: BonusPickerStoryProps) => import("react/jsx-runtime").JSX.Element;
};
export default meta;
